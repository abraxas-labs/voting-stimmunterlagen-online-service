...
namespace Voting.Stimmunterlagen.Data.Migrations
{
    ...
    [Migration("20221104070519_AddVotingCardPrintFileExportJob")]
    partial class AddVotingCardPrintFileExportJob
    {
            ...
            modelBuilder.Entity("Voting.Stimmunterlagen.Data.Models.PrintJob", b =>
                {
                    ...
                    b.Property<int>("VotingCardsPackedCount")
                        .HasColumnType("integer");

                    b.Property<int>("VotingCardsPrintedCount")
                        .HasColumnType("integer");

                    b.Property<int>("VotingCardsSentCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voting.Stimmunterlagen.Data.Models.TemplateDataFieldValue", b =>
                {
                    ...
                    b.HasIndex("FieldId", "DomainOfInfluenceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Voting.Stimmunterlagen.Data.Models.Voter", b =>
                {
                    ...
                    b.OwnsMany("Voting.Stimmunterlagen.Data.Models.VoterDomainOfInfluence", "VoterDomainOfInfluences", b1 =>
                        {
                            b1.Property<Guid>("VoterId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("VoterDomainOfInfluence");
                    ...
                    b.Navigation("VoterDomainOfInfluences");
                });
